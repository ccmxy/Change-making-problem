...
sheet1.write(0, 0, "n")
sheet1.write(0, 1, "changedp")
sheet1.write(0, 2, "greedy")

V = [1, 5, 10, 25, 50]

j = 1
for i in range(2010, 2205, 5):
    setup = "from __main__ import changedp, greedyChange, V, i"
    sheet1.write(j, 0, i)
    time1 = timeit.timeit("changedp(V, i)", setup, number=1)
    sheet1.write(j, 1, time1)
    time2 = timeit.timeit("greedyChange(V, i)", setup, number=1)
    sheet1.write(j, 2, time2)

    j += 1

book.save("question6DataforQ3.xls")
