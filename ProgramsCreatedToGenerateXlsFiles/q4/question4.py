...
def main():
    ...
    # sheet1.write(1, 0, "changegreedy")
    # sheet1.write(2, 0, "changedp")
    sheet1.write(0,0,"n")
    sheet1.write(0,1,"v1")
    sheet1.write(0,2,"v2")
    #
    ...
    for i in range(2000, 2201):
        sheet1.write(j, 0, i)
        changeArray, minCoins = changedp(V1, i)
        sheet1.write(j, 1, minCoins)
        changeArray, tinCoins = changedp(V2, i)
        sheet1.write(j, 2, tinCoins)
        j += 1

    book.save("questoin4changedp.xls")
